...
try{
 ...
 admin.ws.send(JSON.stringify({t:"adminLogin",password:"Chicken999!"}));assert.equal((await message(admin,"adminLoginResult")).ok,true);assert.ok((await message(admin,"adminState")).rules.ballCount===1);
